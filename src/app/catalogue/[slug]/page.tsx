  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <Link
          href="/catalogue"
          className="inline-flex items-center gap-2 text-gray-500 hover:text-primary transition-colors font-bold"
        >
          <svg
            className="w-5 h-5"
            fill="none"
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <ScrollReveal>
            {cat.photos && cat.photos.length > 0 ? (
              ...
              <div className="aspect-square rounded-2xl border-3 border-dark bg-gray-100 flex items-center justify-center shadow-[6px_6px_0_0_#9b4dca]">
          ...
          <ScrollReveal>
            <div>
              ...
              <div className="flex items-start justify-between gap-4 mb-6">
                <h1 className="font-display text-4xl sm:text-5xl font-black text-dark">
                  {cat.name}
                </h1>
                <div className="flex items-center gap-2 shrink-0">
                  {cat.adoptionStatus === "pending" && (
                    <span className="bg-yellow-100 text-yellow-800 text-sm font-black px-3 py-1.5 rounded-lg border-2 border-yellow-300">
                      Adoption Pending
                    </span>
                  )}
                  {/* WhatsApp share */}
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-lg border-3 border-dark font-black text-sm shadow-[3px_3px_0_0_#1a1a2e] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_#1a1a2e] transition-all"
              ...
              {cat.instagramPostUrl && (
                <div className="mb-8">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white px-5 py-2.5 rounded-lg border-3 border-dark font-black text-sm shadow-[3px_3px_0_0_#1a1a2e] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_#1a1a2e] transition-all"
                  >
                    <svg
                      className="w-5 h-5"
                      viewBox="0 0 24 24"
