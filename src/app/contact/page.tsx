    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="max-w-4xl mx-auto">
          {/* Social Links */}
          <ScrollReveal>
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-10">
              Connect With Us
            </h2>
            <div className="grid sm:grid-cols-3 gap-6 mb-16">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 text-center hover:-translate-y-1"
                >
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl ${link.color} text-white mb-4 group-hover:scale-110 transition-transform`}
                  >
                    {link.icon}
                  </div>
