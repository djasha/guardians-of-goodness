 ...
 *
 * lucide-react does not ship brand icons (Instagram, Facebook, LinkedIn),
 * so these are the ONE exception to the "no custom SVGs" rule in CLAUDE.md.
 * All social icon usage across the site imports from this file.
 */
