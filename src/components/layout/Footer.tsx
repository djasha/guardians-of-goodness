        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-14">
          ...
          <div className="md:col-span-5">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 text-white/70 hover:text-secondary transition-colors group"
            >
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-1 gap-2.5">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-white/70 hover:text-white font-medium transition-colors hover:translate-x-1 inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-white/70 text-sm mb-8">Jabal Amman, 1st Circle</p>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                aria-label="Facebook"
                className="neo-border-sm neo-hover bg-white/5 border-white/10 w-11 h-11 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#1877F2]/20 hover:border-[#1877F2]/30 transition-all"
              >
              ...
              <a
                ...
                className="neo-border-sm neo-hover bg-white/5 border-white/10 w-11 h-11 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#E4405F]/20 hover:border-[#E4405F]/30 transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="neo-border-sm neo-hover bg-white/5 border-white/10 w-11 h-11 flex items-center justify-center text-white/70 hover:text-white hover:bg-[#0A66C2]/20 hover:border-[#0A66C2]/30 transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
